...
1. **[Jenkins CI/CD Pipeline with Docker and GitHub](https://github.com/Diplahane/Jenkins-CI-CD-Pipeline-with-Docker-and-GitHub.git)**
   - Automated Jenkins CI/CD pipeline with Docker and GitHub integration for seamless application build, test, and deployment.

2. **[AWS VPC Peering and EC2 Instance Connectivity](https://github.com/Diplahane/AWS-VPC-Perring-and-EC2-Instance-Connectivity.git)**
